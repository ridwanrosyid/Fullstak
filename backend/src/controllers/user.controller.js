...
import { createNotification } from "./notification.controller.js"; // ✅ TAMBAHKAN
...
export async function addAddress(req, res) {
  try {
    ...
    await createNotification(
      ...
      `Anda telah menambahkan alamat baru: ${label || fullName}`,
      "system",
    );
...
export async function updateAddress(req, res) {
  try {
    ...
    await createNotification(
      req.user._id,
      "Alamat Diperbarui",
      `Anda telah memperbarui alamat: ${label || fullName}`,
      "system",
    );
...
export async function deleteAddress(req, res) {
  try {
    ...
    await createNotification(
      req.user._id,
      "Alamat Dihapus",
      `Anda telah menghapus salah satu alamat.`,
      "system",
    );
...
export async function addToWishlist(req, res) {
  try {
    ...
    await createNotification(
      ...
      `Anda menambahkan produk ke wishlist.`,
      "general",
    );
...
export async function removeFromWishlist(req, res) {
  try {
    ...
    await createNotification(
      ...
      `Anda menghapus produk dari wishlist.`,
      "general",
    );
